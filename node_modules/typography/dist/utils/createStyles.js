...
module.exports = function (vr, options) {
  ...
  // Set header sizes.
  var h1 = vr.adjustFontSizeToMSValue(5 / 5);
  var h2 = vr.adjustFontSizeToMSValue(3 / 5);
  var h3 = vr.adjustFontSizeToMSValue(2 / 5);
  var h4 = vr.adjustFontSizeToMSValue(0 / 5);
  var h5 = vr.adjustFontSizeToMSValue(-1 / 5);
  var h6 = vr.adjustFontSizeToMSValue(-1.5 / 5);
  ...
  if ((0, _isFunction2.default)(options.overrideThemeStyles)) {
